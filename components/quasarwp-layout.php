<q-header :reveal="qwpComputedHeaderReveal" :elevated="qwpSelectSeparator('elevated', 'header')"
  ...
  <q-toolbar>
    ...
    <q-toolbar-title class="cursor-pointer" @click="quasarwpRouteTo('/')">
      ...
      <img src="<?php echo get_theme_mod('quasarwp_theme_logo'); ?>"
    ...
    <q-space></q-space>
    <form role="search" method="get" id="qwp-form-search" action="<?php echo get_site_url(); ?>"
      class="qwp-form-search">
      <q-input name="s" id="s" class="qwp-input-search" dense standout="bg-primary" v-model="qwpSearch"
